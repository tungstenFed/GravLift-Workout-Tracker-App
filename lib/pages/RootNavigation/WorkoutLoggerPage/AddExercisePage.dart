...
//Almost identical page to CatalogPage but onTap is different

class AddExercisePage extends StatefulWidget{
  const AddExercisePage({super.key});

  @override
  State<StatefulWidget> createState() { return AddExercisePageState(); }
                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return ListTile(
                            ...
                            onTap: () {
                              //Return data to the previous page by adding parameters after context, will be able to get them
                              //Where you've pushed this page earlier
